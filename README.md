...
I am currently working on 1) a compiler written in C++23, 2) a hardware-accelerated [PBR](https://en.wikipedia.org/wiki/Physically_based_rendering) path tracer 3) drawing stuff :) 
